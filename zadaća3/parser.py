...
class Parser:
    ...
    #   3. broj linije u originalnoj datoteci (u pocetku isti kao 2.)
    ...
    def _write_file(self):
        for (line, p, o) in self._lines: #p -parsirana, o -originalna
            self._outfile.write(line)
            if (line[-1] != "\n"):  # ako nemamo razmak, dodaj ga
                self._outfile.write("\n")
    ...
    def _iter_lines(self, func):
        ...
        for (line, p, o) in self._lines:
            ...
            if (len(newline) > 0):
                ...
                i += 1
        self._lines = newlines  #samo preimenovanje 
